...
namespace System.IO.Abstractions.TestingHelpers
{
    public class PathVerifier
    {
        ...
        private string ExtractFileName(string fullFileName) => fullFileName.Split(_mockFileDataAccessor.Path.DirectorySeparatorChar).Last();

        private string ExtractFilePath(string fullFileName)
        {
            string[] extractFilePath = fullFileName.Split(_mockFileDataAccessor.Path.DirectorySeparatorChar);
