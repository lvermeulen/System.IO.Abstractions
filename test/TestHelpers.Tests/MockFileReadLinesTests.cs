...
namespace System.IO.Abstractions.TestHelpers.Tests
{
    ...
    public class MockFileReadLinesTests {
        ...
        public void MockFile_ReadLines_ShouldReturnOriginalTextData()
        {
            ...
            // Act
            IEnumerable<string> result = file.ReadLines(XFS.Path(@"c:\something\demo.txt"));
        ...
        public void MockFile_ReadLines_ShouldReturnOriginalDataWithCustomEncoding()
        {
            ...
            // Act
            IEnumerable<string> result = file.ReadLines(XFS.Path(@"c:\something\demo.txt"), Encoding.BigEndianUnicode);
