...
namespace System.IO.Abstractions
{
    ...
    public class FileWrapper : FileBase
    {
        ...
        public override StreamWriter AppendText(string path) => File.AppendText(path);
        ...
        public override Stream Create(string path) => File.Create(path);

        public override Stream Create(string path, int bufferSize) => File.Create(path, bufferSize);

        public override Stream Create(string path, int bufferSize, FileOptions options) => File.Create(path, bufferSize, options);

        public override Stream Create(string path, int bufferSize, FileOptions options, FileSecurity fileSecurity) => File.Create(path, bufferSize, options);

        public override StreamWriter CreateText(string path) => File.CreateText(path);
        ...
        public override DateTime GetCreationTime(string path) => File.GetCreationTime(path);

        public override DateTime GetCreationTimeUtc(string path) => File.GetCreationTimeUtc(path);

        public override DateTime GetLastAccessTime(string path) => File.GetLastAccessTime(path);

        public override DateTime GetLastAccessTimeUtc(string path) => File.GetLastAccessTimeUtc(path);

        public override DateTime GetLastWriteTime(string path) => File.GetLastWriteTime(path);
        ...
        public override Stream Open(string path, FileMode mode) => File.Open(path, mode);

        public override Stream Open(string path, FileMode mode, FileAccess access) => File.Open(path, mode, access);

        public override Stream Open(string path, FileMode mode, FileAccess access, FileShare share) => File.Open(path, mode, access, share);

        public override Stream OpenRead(string path) => File.OpenRead(path);

        public override StreamReader OpenText(string path) => File.OpenText(path);

        public override Stream OpenWrite(string path) => File.OpenWrite(path);

        public override byte[] ReadAllBytes(string path) => File.ReadAllBytes(path);

        public override string[] ReadAllLines(string path) => File.ReadAllLines(path);

        public override string[] ReadAllLines(string path, Encoding encoding) => File.ReadAllLines(path, encoding);

        public override string ReadAllText(string path) => File.ReadAllText(path);

        public override string ReadAllText(string path, Encoding encoding) => File.ReadAllText(path, encoding);

        public override IEnumerable<string> ReadLines(string path) => File.ReadLines(path);

        public override IEnumerable<string> ReadLines(string path, Encoding encoding) => File.ReadLines(path, encoding);
